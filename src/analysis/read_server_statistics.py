...
def read_media_statistics(bool_update=False,
    ...
    num_course_videos = data["YouTube"]["Number of YouTube Videos"]
    ...
    size_courses = data["YouTube"]["Total Size"]
    ...
    duration_course_videos = ",".join(data["YouTube"]["Total Duration"].split(",")[:-1])
    ...
    if bool_print:
        ...
        print(f"{Fore.RED}{Style.BRIGHT}YouTube: {Style.NORMAL}{num_course_videos:,} videos | {size_courses} | {duration_course_videos}")
        print(f'\n{"#"*10}\n')
